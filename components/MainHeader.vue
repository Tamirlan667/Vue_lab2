...
<template>
    <header>
        <div class="menu_icon_container">
            <img src="../assets/menu.png" width="35px" height="35px" @click="menuClick">
        </div>
        <div class="content_text">
            <p>New trips on Fall season! Full details on our Instagram accounts.</p>
        </div>
        <div class="profile_icon_container">
            <img src="../assets/profile.png" width="35px" height="35px" @click="profileIconClick">
        </div>
    </header>
    ...
    <PopoverLogin :showPopover="popoverLoginShow" @clickClose="popoverLoginToggle"/>
</template>
<style scoped>
header {
    display: flex;
