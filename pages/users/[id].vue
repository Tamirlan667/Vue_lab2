        ...
        <div class="profile-container">
            <ProfileHeader :user="otherUser.otherUser" title="Profile">
                <div class="profile-actions">
                    <button v-if="currentUser.currentUser && !currentUser.currentUser.friendsId.includes(otherUser.otherUser.id)" class="action-button" @click="handleFollow">FOLLOW</button>
                    <button v-else-if="currentUser.currentUser && currentUser.currentUser.friendsId.includes(otherUser.otherUser.id)" class="action-button" @click="handleUnfollow">FOLLOWING</button>
                    <button class="action-button" @click="handleFriends">FRIENDS</button>
                    <button v-if="currentUser.currentUser" class="action-button" @click="handleChat">CHAT NOW</button>
                </div>
            </ProfileHeader>
