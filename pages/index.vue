...
import "vue-cal/dist/vuecal.css"; // Импортируем стили
...
const handleSelectCategory = (category) => {
  reviewsArr.value =
    reviews.type === "date"
      ? reviews.sortedReviewsByDate
      : reviews.sortedReviews;
  reviewsArr.value = reviewsArr.value.filter(
    (review) => review.blogCategory === category
  );
  currentPage.value = 1;
    ...
    <div class="review-cards">
      ...
      <div class="card-content">
        ...
        <div class="cards">
          <div
            class="card"
            v-for="review in reviewsArr.slice(
...
.card-content {
  ...
  background: linear-gradient(
    ...
    /* 50% transparent white */ rgba(206, 210, 210, 0.8) 40%,
    /* 50% transparent light gray */ rgba(193, 197, 197, 0.8) 62%,
    /* 50% transparent gray */ rgba(184, 187, 187, 0.8) 100%
...
.triangle-down {
  ...
  background: linear-gradient(
    ...
    /* 50% transparent white */ rgba(206, 210, 210, 0.5) 40%,
    /* 50% transparent light gray */ rgba(193, 197, 197, 0.5) 62%,
    /* 50% transparent gray */ rgba(184, 187, 187, 0.5) 100%
      /* 50% transparent darker gray */
  );
}
</style>
